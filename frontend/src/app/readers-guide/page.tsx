...
const text = `
  ...
  The article page is broken into two sections: the Universally Agreed section and the Sources section. The Universally Agreed section is filled with information the LLM has determined to be reported in all of the different categories, whereas each source section cotnains information that is unique to the source or the source highlights more compared to the others.
          ...
          <div className="container mx-auto max-w-4xl px-4 py-8">
            ...
            <div className="mt-1 md:mt-2 py-4 whitespace-pre-line">
              <p className="mt-1 text-md md:text-lg">
                {`  At Tapestry, hope that by openly sharing how our articles are formatted and displayed in Tapestry, we can increase transparency and gain your trust.`}
              </p>
            </div>
            <div className="mt-1 md:mt-2 py-4 whitespace-pre-line">
            ...
            <div className="mt-1 md:mt-2 py-4 whitespace-pre-line">
              ...
              <p className="mt-1 text-md md:text-lg">
                {`The article page is broken into two sections: the Universally Agreed section and the Sources section.

                  The Universally Agreed section is filled with information the LLM has determined to be reported in all of the different categories.

                  Each Source section cotnains information that is unique to the source or the source highlights more compared to the others.

                  The script and prompt that popoulates the article page can be found `}
                <a
